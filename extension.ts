...
namespace animation {
    ...
    /**
     * Sets an animation's frames to an array of images.
     */
    //% block
    //% group="Advanced"
    //% weight=40
    ...
    //% anim.defl=anim
    //% anim.shadow=variables_get
    //% help="Allows the use of animation assets or Image Arrays with advanced animations"
    export function SetAnimationFrames(anim: animation.Animation, frames: Image[]) {
        anim.frames = frames;
    }

    /**
     * Use a single function to create an animation for a sprite.
     */
    //% block
    //% group="Advanced"
    //% weight=41
    //% frames.shadow=animation_editor
    //% anim.shadow=createAnimation
    //% mySprite.defl=mySprite
    //% mySprite.shadow=variables_get
    //% help="Simplifies Advanced Animation creation to help make code more compact"
    export function CreateSpriteAnimation(mySprite: Sprite, anim: animation.Animation, frames: Image[]) {
        anim.frames = frames;
